import { REMOVE_NODE } from '@mapstore/framework/actions/layers';
import { RESET_CONTROLS } from '@mapstore/framework/actions/controls';
import {
    RANGE_CHANGED,
    RANGE_DATA_LOADED,
...
import { SET_INTERVAL_DATA } from '@mapstore/framework/actions/playback';
...
export default (state = {
    ...
    case RANGE_DATA_LOADED: {
        global.console.log('RANGE DATA LOADED')
