...
import { setCollapsed } from '@mapstore/framework/actions/timeline';
import { isCollapsed, hasLayers } from '@mapstore/framework/selectors/timeline';
import { compose, withHandlers, withProps, renderNothing, branch, mapPropsStream } from 'recompose';
import tooltip from '@mapstore/framework/components/misc/enhancers/tooltip';
import { createSelector } from 'reselect';
import { connect } from 'react-redux';
import withPopover from '@mapstore/framework/components/data/featuregrid/enhancers/withPopover';
import RButton from '@mapstore/framework/components/misc/Button';
