...
import {
    ...
    selectLayer,
    SELECT_LAYER
} from '@mapstore/framework/actions/timeline';

import { setCurrentTime, UPDATE_LAYER_DIMENSION_DATA, setCurrentOffset } from '@mapstore/framework/actions/dimension';
import { REMOVE_NODE, CHANGE_LAYER_PROPERTIES } from '@mapstore/framework/actions/layers';
import { error } from '@mapstore/framework/actions/notifications';
import { getLayerFromId } from '@mapstore/framework/selectors/layers';
...
import {
    ...
    offsetTimeSelector,
    currentTimeSelector
} from '@mapstore/framework/selectors/dimension';

import { getNearestDate, roundRangeResolution, isTimeDomainInterval } from '@mapstore/framework/utils/TimeUtils';
import { getHistogram, describeDomains } from '@mapstore/framework/api/MultiDim';
import { getTimeDomainsObservable } from '@mapstore/framework/observables/multidim';
