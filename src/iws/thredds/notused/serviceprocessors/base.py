...
from geonode.services.models import models
...
def get_geoserver_cascading_workspace(create=True):
    """Return the geoserver workspace used for cascaded thredds
    The workspace can be created it if needed.
    """
    name = getattr(settings, "CASCADE_WORKSPACE", "cascaded-thredds")
